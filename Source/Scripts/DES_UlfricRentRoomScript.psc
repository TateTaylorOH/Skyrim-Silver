Scriptname DES_UlfricRentRoomScript extends Actor  Conditional
{script for anyone who rents a room with ulfrics}
...
function RentRoom(DialogueGenericScript pQuestScript)
	...
	Game.GetPlayer().RemoveItem(DES_Ulfric, pQuestScript.RoomRentalCost.GetValueInt())
